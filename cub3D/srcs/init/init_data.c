...
void	init_data(t_data *data)
{
	...
	data->img.addr = mlx_get_data_addr(data->img.img, &(data->img.bpp), &(data->img.llen),
			&(data->img.eda));
	data->tex_north.img = mlx_xpm_file_to_image(data->mlx, "../../walls/north.xpm",
	...
	printf("length: %d\n", data->tex_north.width);

	data->tex_south.img = mlx_xpm_file_to_image(data->mlx, "../../walls/south.xpm",
	...
	data->tex_west.img = mlx_xpm_file_to_image(data->mlx, "../../walls/west.xpm",
	...
	data->tex_east.img = mlx_xpm_file_to_image(data->mlx, "../../walls/east.xpm",
