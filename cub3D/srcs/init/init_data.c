...
/*   Updated: 2025/01/27 13:14:42 by yyamasak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	_init_data(t_data *data)
{
	...
	data->img.addr = mlx_get_data_addr(data->img.img, &(data->img.bpp), &(data->img.llen),
			&(data->img.eda));
	data->tex_north.img = mlx_xpm_file_to_image(data->mlx, data->tex_north.path,
	...
	data->tex_south.img = mlx_xpm_file_to_image(data->mlx, data->tex_south.path,
	...
	data->tex_west.img = mlx_xpm_file_to_image(data->mlx, data->tex_west.path,
	...
	data->tex_east.img = mlx_xpm_file_to_image(data->mlx, data->tex_east.path,
